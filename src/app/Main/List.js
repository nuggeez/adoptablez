...
const List = () => {
  ...
  const handleListPet = () => {
    ...
    if (
      petName &&
      petGender !== null &&
      petType !== null &&  // Validate pet type selection
      petAge &&
      petWeight &&
      petPersonality &&
      petDescription &&
            ...
            <View style={styles.optionsContainer}>
              ...
              >
                <FontAwesome
                  name="paw"
                  size={24}
                  color={petType === "Dog" ? "#68C2FF" : "#C2C2C2"}
                />
                <Text
                  style={[
                    styles.optionText,
              ...
              >
                <FontAwesome
                  name="paw"
                  size={24}
                  color={petType === "Cat" ? "#68C2FF" : "#C2C2C2"}
                />
                <Text
                  style={[
                    styles.optionText,
            ...
            {errors.petType && (
              ...
              <TextInput
                ...
                onChangeText={(text) => {
                  ...
                  setPetWeight(limitedInput ? `${limitedInput}` : ""); // Append "kg" to the value
                }}
